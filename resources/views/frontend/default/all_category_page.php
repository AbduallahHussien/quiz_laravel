<?php
    $category_name        = $this->lang->line('all_category');
    $sub_category_name    = $this->lang->line('all_sub_category');
?>
        ...
        <div class="row">
            <div class="col">
                <div class="category-filter-box filter-box clearfix">
                    <a href = "<?php echo site_url('home/all_category'); ?>" class="btn btn-outline-secondary all-btn"><?php echo $this->lang->line('all'); ?></a>
                </div>
