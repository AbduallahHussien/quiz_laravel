<div class="col-lg-8" style="padding: 35px;">
    <div class="content-box">
        <div class="basic-group">
            <?= form_open_multipart(site_url('home/course_action/edit/'.$course_id)) ?>
            <!--<form action="<?php //echo site_url('home/course_action/edit/'.$course_id); ?>" method="post" enctype="multipart/form-data">-->
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name = "title" id="title" placeholder="<?php echo $this->lang->line('title'); ?>" required value="<?php echo $course_details['title']; ?>">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="level">
                        <option value="beginner" <?php if($course_details['level'] == "beginner") echo 'selected'; ?>><?php echo $this->lang->line('beginner'); ?></option>
                        <option value="advanced" <?php if($course_details['level'] == "advanced") echo 'selected'; ?>><?php echo $this->lang->line('advanced'); ?></option>
                        <option value="intermediate" <?php if($course_details['level'] == "intermediate") echo 'selected'; ?>><?php echo $this->lang->line('intermediate'); ?></option>
                    </select>
                </div>
            ...
            <div class="basic-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="course_overview_provider">
                        <option value="youtube" <?php if($course_details['course_overview_provider'] == 'youtube') echo 'selected'; ?>><?php echo $this->lang->line('youtube'); ?></option>
                        <option value="vimeo" <?php if($course_details['course_overview_provider'] == 'vimeo') echo 'selected'; ?>><?php echo $this->lang->line('vimeo'); ?></option>
                        <option value="html5" <?php if($course_details['course_overview_provider'] == 'html5') echo 'selected'; ?>><?php echo $this->lang->line('HTML5'); ?></option>
                    </select>
                </div>
            ...
            <div class="content-update-box">
                <button type="submit" name = "publish" class="btn col-4"><?php echo $this->lang->line('publish_this_course'); ?></button>
