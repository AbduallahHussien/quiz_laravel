            ...
            <div class="col">
                <ul class="purchase-history-list">
                    <li class="purchase-history-list-header">
                        <div class="row">
                            <div class="col-sm-6"><h4 class="purchase-history-list-title"> <?php echo $this->lang->line('purchase_history'); ?> </h4></div>
                            <div class="col-sm-6 hidden-xxs hidden-xs">
                                <div class="row">
                                    <div class="col-sm-3"> <?php echo $this->lang->line('date'); ?> </div>
                                    <div class="col-sm-3"> <?php echo $this->lang->line('total_price'); ?> </div>
                                    <div class="col-sm-4"> <?php echo $this->lang->line('payment_type'); ?> </div>
                                    <div class="col-sm-2"> <?php echo $this->lang->line('actions'); ?> </div>
                                </div>
                            </div>
                        </div>
                    </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 purchase-history-detail">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                <a href="<?php echo site_url('home/invoice/'.$each_purchase['id']); ?>" target="_blank" class="btn btn-receipt"><?php echo $this->lang->line('invoice'); ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
