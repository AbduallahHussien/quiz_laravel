                ...
                <div class="course-box">
                    ...
                    <div class="" id = "course_info_view_<?php echo $my_course['id'];  ?>">
                      <div class="course-details">
                          ...
                          <small><?php echo ceil(course_progress($my_course['id'])); ?>% <?php echo $this->lang->line('completed'); ?></small>
                      ...
                      <div class="row" style="padding: 5px;">
                          <div class="col-md-6">
                              <a href="<?php echo site_url('home/course/'.rawurlencode(slugify($course_details['title'])).'/'.$my_course['id']); ?>" class="btn"><?php echo $this->lang->line('course_detail'); ?></a>
                          </div>
                          <div class="col-md-6">
                               <a href="<?php echo site_url('home/lesson/'.rawurlencode(slugify($course_details['title'])).'/'.$my_course['id']); ?>" class="btn"><?php echo $this->lang->line('start_lesson'); ?></a>
                          </div>
                      </div>
                    </div>
                        ...
                        <div class="form-group select">
                          <div class="styled-select">
                            <select class="form-control" name="star_rating" id="star_rating_of_course_<?php echo $course_details['id']; ?>">
                              <option value="1" <?php if ($user_specific_rating['rating'] == 1): ?>selected=""<?php endif; ?>>1 <?php echo $this->lang->line('out_of'); ?> 5</option>
                              <option value="2" <?php if ($user_specific_rating['rating'] == 2): ?>selected=""<?php endif; ?>>2 <?php echo $this->lang->line('out_of'); ?> 5</option>
                              <option value="3" <?php if ($user_specific_rating['rating'] == 3): ?>selected=""<?php endif; ?>>3 <?php echo $this->lang->line('out_of'); ?> 5</option>
                              <option value="4" <?php if ($user_specific_rating['rating'] == 4): ?>selected=""<?php endif; ?>>4 <?php echo $this->lang->line('out_of'); ?> 5</option>
                              <option value="5" <?php if ($user_specific_rating['rating'] == 5): ?>selected=""<?php endif; ?>>5 <?php echo $this->lang->line('out_of'); ?> 5</option>
                            </select>
                          </div>
                        </div>
                        <div class="form-group add_top_30">
                          <textarea name="review" id ="review_of_a_course_<?php echo $course_details['id']; ?>" class="form-control" style="height:120px;" placeholder="<?php echo $this->lang->line('write_your_review_here'); ?>"><?php echo $user_specific_rating['review']; ?></textarea>
                        </div>
                        <button type="" class="btn btn-block" onclick="publishRating('<?php echo $course_details['id']; ?>')" name="button"><?php echo $this->lang->line('publish_rating'); ?></button>
                        <a href="javascript::" class="btn btn-block" onclick="toggleRatingView('<?php echo $course_details['id']; ?>')" name="button"><?php echo $this->lang->line('cancel_rating'); ?></a>
                      </form>
                    </div>
                </div>
        </div>
