            ...
            <div class="col">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#"><?php echo $this->lang->line('shopping_cart'); ?></a></li>
                    </ol>
                </nav>
                <h1 class="page-title"><?php echo $this->lang->line('shopping_cart'); ?></h1>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row" id = "cart_items_details">
            <div class="col-lg-9">
                ...
                <div class="in-cart-box">
                    <div class="title"><?php echo sizeof($this->session->userdata('cart_items')).' '.$this->lang->line('courses_in_cart'); ?></div>
                    <div class="">
                                ...
                                <li>
                                    <div class="cart-course-wrapper">
                                        ...
                                        <div class="move-remove">
                                            <div id = "<?php echo $course_details['id']; ?>" onclick="removeFromCartList(this)"><?php echo $this->lang->line('remove'); ?></div>
            ...
            <div class="col-lg-3">
                <div class="cart-sidebar">
                    <div class="total"><?php echo $this->lang->line('total'); ?>:</div>
                    ...
                    <button type="button" class="btn btn-primary btn-block checkout-btn" onclick="handleCheckOut()"><?php echo $this->lang->line('checkout'); ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    $.ajax({
        ...
        success: function(response)
        {
            if (!response) {
                ...
                toastr.error('<?php echo $this->lang->line('there_are_no_courses_on_your_cart');?>');
            }
        }
    });
}
