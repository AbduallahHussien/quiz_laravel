    ...
    <div class="row">
        <div class="col">
            <table class = "table">
                <thead>
                    <tr>
                        <th><?php echo $this->lang->line('course_title'); ?></th>
                        <th><?php echo $this->lang->line('total_amount'); ?></th>
                        <th><?php echo $this->lang->line('instructor_revenue'); ?></th>
                ...
                <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($payment_history['instructor_payment_status'] == 1): ?>
                                        <span style="font-weight: bold; color: #4CAF50;"><?php echo $this->lang->line('paid'); ?></span>
                                    <?php elseif($payment_history['instructor_payment_status'] == 0): ?>
                                        <span style="font-weight: bold; color: #f44336;"><?php echo $this->lang->line('pending'); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="5"><span><?php echo $this->lang->line('no_payment_history_found'); ?></span></td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
