...
<div class="col-lg-5" style="padding: 35px 0px;" id = "add_form_area">
    <div class="content-box" id = "lesson_adding_form_area">
        <?= form_open_multipart(site_url('home/manage_lessons/add/'.$course_id), ' role="form" class="form-horizontal form-groups-bordered"') ?>
        <!--<form role="form" class="form-horizontal form-groups-bordered" action="<?php //echo site_url('home/manage_lessons/add/'.$course_id); ?>" method="post" enctype="multipart/form-data">-->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <select class="form-control" id="lesson_type" name="lesson_type" required onchange="show_lesson_type_form(this.value)">
                        ...
                        <option value="video-url"><?php echo $this->lang->line('video_url'); ?></option>
                        <option value="other-txt"><?php echo $this->lang->line('text_file'); ?></option>
                        <option value="other-pdf"><?php echo $this->lang->line('pdf_file'); ?></option>
                        <option value="other-doc"><?php echo $this->lang->line('document_file'); ?></option>
                        <option value="other-img"><?php echo $this->lang->line('image_file'); ?></option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-12">
                    <button class = "btn btn-success" type="submit" name="button"><?php echo $this->lang->line('add_lesson'); ?></button>
                </div>
            </div>
        <?= form_close() ?>
    </div>
    ...
    <div class="content-box" id = "lesson_editing_form_area" style="display: none;">
        <?= form_open_multipart('', ' role="form" id = "lesson_editing_form" class="form-horizontal form-groups-bordered"') ?>
            ...
            <div class="" id = "youtube_vimeo_for_updating" style="display: none;">
              <div class="form-group">
                  ...
                  <div class="col-sm-12">
                      ...
                      <label class="form-label" id = "invalid_url_for_updating" style ="margin-top: 4px; color: red; display: none;"><?php echo $this->lang->line('invalid_url').'. '.$this->lang->line('your_video_source_has_to_be_either_youtube_or_vimeo'); ?></label>
                      <label class="form-label" id = "preloader_for_updating" style ="margin-top: 4px; color: #000; display: none;"><i class="fas fa-spinner fa-pulse" aria-hidden="true"></i> &nbsp;<?php echo $this->lang->line('analyzing_given_url').'....'; ?></label>
                  </div>
              </div>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-12">
                    ...
                    <button class = "btn btn-success" type="button" name="button" onclick="resetForm()"><?php echo $this->lang->line('reset'); ?></button>
                </div>
            </div>
        <?= form_close() ?>
    </div>
