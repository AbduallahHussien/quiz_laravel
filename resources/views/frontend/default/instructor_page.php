            ...
            <div class="col-lg-9">
                <div class="instructor-right-box">
                    ...
                    <div class="biography-content-box view-more-parent">
                        <div class="view-more" onclick="viewMore(this,'hide')"><b><?php echo $this->lang->line('show_full_biography'); ?></b></div>
                    ...
                    <div class="instructor-stat-box">
                        <ul>
                            <li>
                                <div class="small"><?php echo $this->lang->line('total_student'); ?></div>
                                <div class="num">
                                    <?php
                            ...
                            <li>
                                <div class="small"><?php echo $this->lang->line('courses'); ?></div>
                                <div class="num"><?php echo sizeof($course_ids); ?></div>
                            </li>
                            <li>
                                <div class="small"><?php echo $this->lang->line('reviews'); ?></div>
