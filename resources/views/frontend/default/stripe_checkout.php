        ...
        <!-- <img src="<?php echo base_url('uploads/system/'.get_frontend_settings('light_logo')); ?>" width="15%;" style="opacity: 0.05;" id="application-logo"> -->
            ...
            >
              <label>
                  ...
                  <span><span><?php echo $this->lang->line('credit_or_debit_card');?></span></span>
              </label>
              <button type="submit" id = "stripe_pay_button">
                  <?php echo $this->lang->line('pay');?> <?php echo $amount_to_pay.' '.get_settings('stripe_currency');?>
              </button>
              <div class="outcome">
              ...
              <div class="package-details">
                  <strong><?php echo $this->lang->line('student_name');?> | <?php echo $user_details['first_name'].' '.$user_details['last_name'];?></strong> <br>
              </div>
