<section class="menu-area bg-white">
  <div class="container-xl">
    <nav class="navbar navbar-expand-lg bg-white">
      ...
      <?= form_open(site_url('home/search'), ' class="inline-form me-auto"') ?>
      <!--<form class="inline-form me-auto" action="<?php echo site_url('home/search'); ?>" method="get">-->
        <div class="input-group search-box mobile-search">
          <input type="text" name = 'query' value="<?php echo $this->input->post('query') ? $this->input->post('query') : ""; ?>" class="form-control" placeholder="<?php echo site_phrase('search_for_courses'); ?>">
