        ...
        <div class="row">
            <div class="col position-relative">
                <div class="home-banner-wrap">
                    ...
                    <?= form_open(site_url('home/search'),' class="search-box-shadow"') ?>
...
<section class="mb-5 pb-4">
    <div class="container-lg">
        ...
        <div class="row justify-content-center">
            ...
            <?php $top_10_categories = $this->crud_model->get_top_categories(12); ?>
            <?php foreach($top_10_categories as $top_10_category): ?>
                <?php $category_details = $this->crud_model->get_category_details_by_id($top_10_category['cat_id'])->row_array(); ?>
