...
<div class="cookieConsentContainer" id="cookieConsentContainer" style="opacity: .9; display: block; display: none;">
  ...
  <div class="cookieDesc">
    <p>
      ...
      <a class="link-cookie-policy" href="<?php echo site_url('home/cookie_policy'); ?>"><?php echo $this->lang->line('cookie_policy'); ?></a>
    </p>
  </div>
  <div class="cookieButton">
    <a onclick="cookieAccept();"><?php echo $this->lang->line('accept'); ?></a>
  </div>
</div>
<script>
