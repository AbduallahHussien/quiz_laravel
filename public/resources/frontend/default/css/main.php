<?php
    ...
    $custom = 0;
    if(file_exists('../../../../theme_colors.txt')){
        $myfile = fopen("../../../../theme_colors.txt", "r");
        if(filesize("../../../../theme_colors.txt") != 0) {
            $colors= fread($myfile,filesize("../../../../theme_colors.txt"));
                if($colors != ''){
                    $custom=1;
                }
        }
    ...
    if($custom==1){
        ...
        $btn_color = $colors_arr[0];
        $header_color = $colors_arr[1];
        $light_clr_in_gradient = $colors_arr[2];
    }else{
        $btn_color = '#1c70b8';
        $header_color = '#0f334a';
        $light_clr_in_gradient = '#36a8e0';
    }
?>
@font-face {
    font-family: 'Almarai';
...
@font-face {
    ...
    src: url('../../../fonts/almarai-bold-700.woff2') format('woff2'),
        url('../../../fonts/almarai-bold-700.woff') format('woff');
    font-weight: normal;
    font-style: normal;
}
...
.home-fact-area{
    background-color: <?= $btn_color ?>;
    background: -webkit-linear-gradient(-45deg,<?= $light_clr_in_gradient ?>,<?= $header_color ?>);
    background: -moz-linear-gradient(-45deg,<?= $light_clr_in_gradient ?> 0,<?= $header_color ?> 100%);
    background: -ms-linear-gradient(-45deg,<?= $light_clr_in_gradient ?> 0,<?= $header_color ?> 100%);
    background: -o-linear-gradient(-45deg,<?= $light_clr_in_gradient ?> 0,<?= $header_color ?> 100%);
    background: linear-gradient(-45deg,<?= $light_clr_in_gradient ?>,<?= $header_color ?>);
    color: #fff;
    padding: 15px 0;
    margin-bottom: 50px
}
...
.course-curriculum-accordion .lecture-list .list:before {
    content: "\f022";
    font-size: 17px;
}
.course-curriculum-accordion .lecture-list .video:before {
    content: "\f144";
    font-size: 17px;
}
...
.footer-area{
    background-color: #fff;
    padding: 30px 0;
    border-bottom: 6px solid <?= $btn_color ?>;
    border-top: 1px solid #e8e9eb;
}
.copyright-text{
    color: #686f7a;
...
.rtl .home-banner-wrap .btn {
    border-radius: 3px 0px 0px 3px !important;
}
.rtl .home-banner-wrap input[type="text"] {
...
.rtl .main-nav-wrap>ul>li>ul>li a .icon{
    margin-left: 20px;
}
.rtl .menu-icon-box .dropdown{
    left: 0px;
    right: inherit;
}
...
.rtl .user-dropdown-menu li a i{
    margin: 0 10px 0 19px;
}
.rtl .main-nav-wrap>ul>li>ul{
    left: inherit;
}
.rtl .main-nav-wrap ul li ul{
    right: 0px;
}
.rtl .my-course-search-bar .input-group{
    float: left;
}
.rtl .float-left{
...
.course-curriculum-accordion .lecture-list .quiz:before {
    content: "\f059";
    font-size: 17px;
}
.course-curriculum-accordion .lecture-list .quiz_taken:before {
    content: "\f058";
    color: green;
    font-size: 17px;
}
.course-price-rating i{
...
.already_purchased .btn-success{
    color: #fff !important;
    background-color: #28a745;
    border-color: #28a745;
}
.rtl .footer-menu .nav-item:not(:last-child){
    margin-left: 20px;
}
.language_selector{
    margin-top: 6px;
...
.rtl .home-fact-box .text-box {
    padding: 10px 63px 10px 0px;
}
.rtl .mr-auto,.rtl .mx-auto {
    margin-left: auto!important;
}
.user-submenu-home-dropdown{
    cursor: default;
}
.rtl .course-subtitle,.rtl .course-title, .rtl .course-meta,.rtl .what-will-learn{
    text-align: right;
    direction: rtl;
}
.rtl .add-to-cart-btn{
