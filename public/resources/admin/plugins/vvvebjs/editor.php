...
<html lang="en">
  <head>
    ...
    <link href="assets/admin/plugins/vvvebjs/css/editor.css" rel="stylesheet">
    <link href="assets/admin/plugins/vvvebjs/css/line-awesome.css" rel="stylesheet">
...
<body>
	...
	<div id="vvveb-builder">
				...
				<div id="top-panel">
					...
					<!--<img src="assets/admin/plugins/vvvebjs/img/logo.png" alt="Vvveb" class="float-left" id="logo">-->
					
					<a href="javascript:void(0)" onclick="$('#dynamic_fields_instructions').modal('show')" class="btn btn-primary font-weight-bold btn-square pull-left" style="border-radius: 0px;"><?= $this->lang->line('dynamic_fields') ?></a>
					<div class="btn-group float-left" role="group">
					  <button class="btn btn-light" title="Toggle file manager" id="toggle-file-manager-btn" data-vvveb-action="toggleFileManager" data-toggle="button" aria-pressed="false">
						  <img src="assets/admin/plugins/vvvebjs/libs/builder/icons/file-manager-layout.svg" width="20px" height="20px">
					  </button>
					  ...
					  <button class="btn btn-light" title="Toggle left column" id="toggle-left-column-btn" data-vvveb-action="toggleLeftColumn" data-toggle="button" aria-pressed="false">
						  <img src="assets/admin/plugins/vvvebjs/libs/builder/icons/left-column-layout.svg" width="20px" height="20px">
					  </button>
					  ...
					  <button class="btn btn-light" title="Toggle right column" id="toggle-right-column-btn" data-vvveb-action="toggleRightColumn" data-toggle="button" aria-pressed="false">
						  <img src="assets/admin/plugins/vvvebjs/libs/builder/icons/right-column-layout.svg" width="20px" height="20px">
					  </button>
					</div>
				...
				<div id="left-panel">
					  ...
					  <div id="filemanager"> 
							<div class="header">
								<a href="#" class="text-secondary">Certificates</a>
									...
									<div class="btn-group responsive-btns mr-4 float-right" role="group">
									  <button class="btn btn-link btn-sm" title="New file" id="new-file-btn" data-vvveb-action="newPage" data-vvveb-shortcut="">
										  <i class="la la-file"></i> <small>New Certificate</small>
									  </button>
...
<div class="modal fade" id="new-page-modal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <p class="modal-title text-primary"><i class="la la-lg la-file"></i> New Certificate</p>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true"><small><i class="la la-close"></i></small></span>
        </button>
      </div>
    ...
    <!-- Modal-->
<div class="modal fade" id="dynamic_fields_instructions" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><?= $this->lang->line('instructions') ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <ul class="ins_list">
                    <li><?= $this->lang->line('fields_instructions_eng_name') ?> </li>
                    <li><?= $this->lang->line('fields_instructions_ar_name') ?> </li>
                    <li><?= $this->lang->line('fields_instructions_id') ?> </li>
                    <li><?= $this->lang->line('fields_instructions_degree') ?></li>
                    <li><?= $this->lang->line('fields_instructions_course_name') ?></li>
                    <li><?= $this->lang->line('fields_instructions_percentage') ?></li>
                </ul>
            </div>
            <div class="modal-footer">
...
<!-- jquery-->
<script src="assets/admin/plugins/vvvebjs/js/jquery.min.js"></script>
<script src="assets/admin/plugins/vvvebjs/js/jquery.hotkeys.js"></script>

<!-- bootstrap-->
<script src="assets/admin/plugins/vvvebjs/js/popper.min.js"></script>
<script src="assets/admin/plugins/vvvebjs/js/bootstrap.min.js"></script>

<!-- builder code-->
<script src="assets/admin/plugins/vvvebjs/libs/builder/builder.js"></script>	
<!-- undo manager-->
<script src="assets/admin/plugins/vvvebjs/libs/builder/undo.js"></script>	
<!-- inputs-->
<script src="assets/admin/plugins/vvvebjs/libs/builder/inputs.js"></script>	
...
<!-- components-->
<script src="assets/admin/plugins/vvvebjs/libs/builder/components-server.js"></script>	
<script src="assets/admin/plugins/vvvebjs/libs/builder/components-bootstrap4.js"></script>	
<script src="assets/admin/plugins/vvvebjs/libs/builder/components-widgets.js"></script>	

<!-- blocks-->
<script src="assets/admin/plugins/vvvebjs/libs/builder/blocks-bootstrap4.js"></script>	

<!-- plugins -->

<!-- code mirror - code editor syntax highlight -->
<link href="assets/admin/plugins/vvvebjs/libs/codemirror/lib/codemirror.css" rel="stylesheet"/>
<link href="assets/admin/plugins/vvvebjs/libs/codemirror/theme/material.css" rel="stylesheet"/>
<script src="assets/admin/plugins/vvvebjs/libs/codemirror/lib/codemirror.js"></script>
<script src="assets/admin/plugins/vvvebjs/libs/codemirror/lib/xml.js"></script>
<script src="assets/admin/plugins/vvvebjs/libs/codemirror/lib/formatting.js"></script>
<script src="assets/admin/plugins/vvvebjs/libs/builder/plugin-codemirror.js"></script>	
...
<script src="assets/admin/plugins/vvvebjs/libs/autocomplete/jquery.autocomplete.js"></script>	
...
$(document).ready(function() 
{
	...
	[
		//{name:"certificates", title:"Certificates",  url: "certificates/index.html", assets: ['demo/certificates/style.css']},
		...
		<?php 
		   $htmlFiles = scandir("certificates");
                   $i=0;
                   $firstFileName = '';
		   foreach ($htmlFiles as $file) { 
			   if (in_array($file, array('new-page-blank-template.html', 'editor.html','..','.'))) continue;//skip template files
			   $pathInfo = pathinfo($file);
                           $firstFileName = $i == 0?ucfirst($pathInfo['filename']):$firstFileName;
                           $i++;
		?>
		{name:"<?php echo ucfirst($pathInfo['filename']);?>", title:"<?php echo ucfirst($pathInfo['filename']);?>",  url: "<?php echo 'certificates/'.$pathInfo['basename'];?>"},
		<?php } ?>
		
		//{name:"test", title:"test",  url: "http://vvveb_install.givan.ro/"},
	]);
	<?php if($firstFileName!=''){?>
            Vvveb.FileManager.loadPage("<?= $firstFileName ?>");
        <?php } ?>
});
</script>
</body>
