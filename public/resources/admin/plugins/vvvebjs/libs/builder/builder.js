				...
				for (i in components)
				{
					...
					if (component)
					{
						...
						if (component.image) {
							...
							item.css({
								backgroundImage: "url(" + 'assets/admin/plugins/vvvebjs/libs/builder/' + component.image + ")",
...
/* drag and drop */
	...
	saveAjax: function(fileName, startTemplateUrl, callback)
	{
		...
		$.ajax({
			type: "POST",
			url: 'assets/admin/plugins/vvvebjs/save.php',//set your server side save script url
			data: data,
			cache: false,
