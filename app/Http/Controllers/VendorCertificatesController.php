...
class VendorCertificatesController extends Controller
{
            ...
            $data = $this->certificates_service->prepare_data_table($request->item_id);
                ...
                return Datatables::of($data)
                    ...
                    ->addColumn('actions', function($row){
                        ...
                        $btn ="";
                        $btn .=' <a href="'.route('vendor_certificates.edit',$row->id).'"  class="edit" title="'.__('Edit').'" data-toggle="tooltip"><i class="material-icons">&#xE254;</i>';
                        $btn .='<a href="'.route('vendor_certificates.destroy',$row->id).'" data-id="'.$row->id.'" class="delete delete-icon" title="'.__('Delete').'" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>';
                        return $btn;
    ...
    public function create(Request $request)
    {
        ...
        return view('vendors.paintings.certificates-form',compact('certificate','painting_id'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return jsonResponse(['certificate'=>$certificate,'redirect_url'=> route('vendor_paintings.edit',$certificate->painting_id)],200,__('Certificate created successfully'));
    }
    ...
    public function edit($id)
    {
        ...
        if($model){
            ...
            return view('vendors.paintings.certificates-form', compact('certificate'));
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return jsonResponse(['certificate'=>$certificate, 'redirect_url'=> route('vendor_paintings.edit',$certificate->painting_id)],200,__('Certificate updated successfully'));
    }
